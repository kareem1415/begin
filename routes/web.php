...
Route::get('get-user-has-phone-with-condition', 'Relation\RelationsController@getUserWhereHasPhoneWithCondithion');
...
Route::get('hospitals_not_has_doctors_male', 'Relation\RelationsController@hospitalsNotHasDoctorsMale');
...
Route::post('saveServices-to-doctor', 'Relation\RelationsController@saveServiceToDoctors')-> name('save.doctors.services');
...
Route::get('accessors', 'Relation\RelationsController@getDoctor'); // get
